...
public class ChessMoveController {
    ...
    public void playerMove(@DestinationVariable(value = "id") String gameId,
        ...
        log.debug("board state (gameid {}):\n{}\n",
                gameId, chessRoomManager.getPrettyBoardStr(gameId));

        sendBoardUpdate(gameId, message.get(), chessRoomManager.getGameStateFromId(gameId),
                !isWhitesTurn.get());
    }
